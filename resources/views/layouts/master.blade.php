        ...
        <div class="container">
            <div class="row">
                ...
                <div class="subscribe col-md-5">
                    ...
                    <img loading="lazy" src="{{ asset('assets/img/connect/fb.png') }}" alt="facebook"> Facebook
                    </a>
                 &emsp;
                    <a href="https://www.zalo.me/">
                    <img loading="lazy" src="{{ asset('assets/img/connect/zl.png') }}" alt="facebook">  Zalo
                    </a>
              <br>
              <br>
                    <a href="https://www.instagram.com/">
                    <img loading="lazy" src="{{ asset('assets/img/connect/insta.png') }}" alt="facebook">  Instagram
                    </a>
                 &emsp;
                    <a href="https://www.youtube.com/">
                    <img loading="lazy" src="{{ asset('assets/img/connect/yt.png') }}" alt="facebook">  Youtobe
                    </a>
               <br>
               <br>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <p class="copyright mb-md-0 text-center text-md-left">© 2021 Marcho</p>
                    </div>
                    <div class="col-md-6">
